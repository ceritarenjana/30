    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {/* Total Events */}
          <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col justify-between min-h-[140px]">
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          {/* System Log */}
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-6">System Log</h3>
            {/* Tabel log, contoh statis, ganti dengan data log asli jika ada */}
            <div className="overflow-x-auto">
              <table className="w-full text-xs">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-3 py-2 text-left font-semibold text-gray-500 uppercase tracking-wider">Time</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-500 uppercase tracking-wider">User</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-500 uppercase tracking-wider">Action</th>
                    <th className="px-3 py-2 text-left font-semibold text-gray-500 uppercase tracking-wider">Detail</th>
                  </tr>
                </thead>
                <tbody>
                  {/* Contoh data statis, ganti dengan map log jika sudah ada */}
                  <tr>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-700">06/06/2025, 10:12</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-900 font-medium">admin</td>
                    <td className="px-3 py-2 whitespace-nowrap text-green-700">Create Event</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-500">Seminar: Mobile App Development</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-700">06/06/2025, 10:15</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-900 font-medium">admin</td>
                    <td className="px-3 py-2 whitespace-nowrap text-red-700">Delete Event</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-500">Workshop: Digital Marketing</td>
                  </tr>
                  <tr>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-700">06/06/2025, 10:20</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-900 font-medium">admin</td>
                    <td className="px-3 py-2 whitespace-nowrap text-blue-700">Update Ticket</td>
                    <td className="px-3 py-2 whitespace-nowrap text-gray-500">Token: DM2025002EFG</td>
                  </tr>
                </tbody>
              </table>
              {/* Jika belum ada data log, tampilkan placeholder */}
              {/* <div className="text-gray-400 text-sm text-center py-8">No system log yet</div> */}
            </div>
          </div>
        </div>
      </div>
